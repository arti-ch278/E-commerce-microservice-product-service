...
public class ProductController {
	...
	@Operation(summary = "Create a new product",
			description = "Creates a new product with the provided details. JWT required for authorization.", 
	...
	@GetMapping("/")
	public ResponseEntity<Page<ProductDto>> getAllProducts(@Parameter(description = "Page number (default 0)") @RequestParam(defaultValue = "0") int page,
...
public ResponseEntity<ProductDto> uploadImage(@PathVariable Long id ,
		 @Parameter(description = "Product image file", content = @Content(schema = @Schema(type = "string", format = "binary")))
